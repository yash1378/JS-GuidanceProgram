...
function Registration() {
  ...
  return (
    <>
    <body className="bg-gray-800 pt-10 h-[100vh]">
      
    
      <div
        className="mx-auto shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] bg-slate-950   p-4 rounded-lg text-white dark:bg-gray-800"
        style={{ maxWidth: "60vw", boxShadow: "20px 20px 20px rgba(0, 0, 0, 0.7)" }}
      >
        <form className="bg-slate-950">
          <div className="mb-4 ">
            <label
              htmlFor="studentName"
