  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8000/api/mentorData/",
        {
          method: "POST",
          headers: {
          ...
          <form>
            ...
            <div className="mb-4 md:flex md:space-x-2">
              ...
              {isModalVisible && (
                <>
                  <div
                    className=" fixed top-0 left-0 z-10 w-full min-h-screen bg-black opacity-70 transition-opacity duration-300 ease-in-out" // Close the sidebar when overlay is clicked
                  ></div>
